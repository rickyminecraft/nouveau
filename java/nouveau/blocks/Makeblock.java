...
public class Makeblock
{
	...
	{
		BlocksNames.ItemDoor1 = new TallBlockItem(BlocksNames.Door1, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_diamant");
		BlocksNames.ItemDoor2 = new TallBlockItem(BlocksNames.Door2, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_or");
		BlocksNames.ItemDoor3 = new TallBlockItem(BlocksNames.Door3, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_0");
		BlocksNames.ItemDoor4 = new TallBlockItem(BlocksNames.Door4, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_fer_0");
		BlocksNames.ItemDoor5 = new TallBlockItem(BlocksNames.Door5, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_1");
		BlocksNames.ItemDoor6 = new TallBlockItem(BlocksNames.Door6, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_2");
		BlocksNames.ItemDoor7 = new TallBlockItem(BlocksNames.Door7, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_3");
		BlocksNames.ItemDoor8 = new TallBlockItem(BlocksNames.Door8, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_4");
		BlocksNames.ItemDoor9 = new TallBlockItem(BlocksNames.Door9, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_5");
		BlocksNames.ItemDoor10 = new TallBlockItem(BlocksNames.Door10, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_6");
		BlocksNames.ItemDoor11 = new TallBlockItem(BlocksNames.Door11, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_7");
		BlocksNames.ItemDoor12 = new TallBlockItem(BlocksNames.Door12, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_8");
		BlocksNames.ItemDoor13 = new TallBlockItem(BlocksNames.Door13, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_fer_1");
		BlocksNames.ItemDoor14 = new TallBlockItem(BlocksNames.Door14, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_fer_2");
		BlocksNames.ItemDoor15 = new TallBlockItem(BlocksNames.Door15, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_fer_3");
		BlocksNames.ItemDoor16 = new TallBlockItem(BlocksNames.Door16, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_9");
		BlocksNames.ItemDoor17 = new TallBlockItem(BlocksNames.Door17, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_10");
		BlocksNames.ItemDoor18 = new TallBlockItem(BlocksNames.Door18, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_11");
		BlocksNames.ItemDoor19 = new TallBlockItem(BlocksNames.Door19, (new Item.Properties()).tab(Blocks.blocksTab2)).setRegistryName("porte_bois_12");
	}
}